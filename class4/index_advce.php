...
<body>
    ...
    <?php
$scl_name = "Barajan S C High School";
$scl_address = "Barajan, Kakina, Kaligonj, Lalmonirhat";
$exam_year = "2022";
$name = "Md Shariful Islam";
$father_name = "Md Enamul Haque Kabir";
$mother_name = "Most Sayeda Banu";
$roll = "101369";
$registration = "1500900386";
$department = "Science";
$seasion = "21-22";
...
elseif($social_science_science >= 70 && $social_science <= 79 ){
    $social_science_grade = "A";
}
